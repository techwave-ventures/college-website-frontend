(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_21ee67e5._.js", {
...
function CreateCollegeForm() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CreateCollegeForm.useEffect": ()=>{
            const fetchExams = {
                "CreateCollegeForm.useEffect.fetchExams": async ()=>{
                    try {
                        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("https://college-website-backend-main.onrender.com/apiv1/exam");
                        setExams(res.data.body);
                    } catch (error) {
                        console.error(error);
                    }
                }
            }["CreateCollegeForm.useEffect.fetchExams"];
            fetchExams();
        }
    }["CreateCollegeForm.useEffect"], []);
    const handleExamSelect = async (examId)=>{
        ...
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`https://college-website-backend-main.onrender.com/apiv1/exam/${examId}`);
    ...
    const uploadImage = async (file)=>{
        ...
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("https://college-website-backend-main.onrender.com/apiv1/image", form);
    ...
    const handleCutoffImageUpload = async (e, courseIndex, branchIndex, cutoffIndex)=>{
        const file = e.target.files[0];
        const imageId = await uploadImage(file);
        const updatedFormData = {
            ...formData
        };
        updatedFormData.data.courses[courseIndex].branches[branchIndex].cutOffs[cutoffIndex].image = imageId;
        setFormData(updatedFormData);
    };
    const addReview = ()=>setFormData({
            ...formData,
            data: {
                ...formData.data,
                reviews: [
    ...
    const addBranch = (index)=>setFormData({
            ...formData,
            data: {
                ...formData.data,
                courses: formData.data.courses.map((c, i)=>i === index ? {
                        ...c,
                        branches: [
                            ...c.branches,
                            {
    ...
    const addCutoff = (courseIndex, branchIndex)=>setFormData({
            ...formData,
            data: {
                ...formData.data,
                courses: formData.data.courses.map((c, i)=>i === courseIndex ? {
                        ...c,
                        branches: c.branches.map((b, j)=>j === branchIndex ? {
                                ...b,
                                cutOffs: [
                                    ...b.cutOffs,
                                    {
    ...
    const handleSubmit = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("https://college-website-backend-main.onrender.com/apiv1/college", formData);
            alert("College created successfully!");
            console.log(response.data);
        } catch (error) {
            console.error("Error creating college:", error);
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$select$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Select"], {
                        onValueChange: (value)=>handleExamSelect(value),
                        children: [
                    ...
                    formData.data.reviews.map((review, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "mt-4",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$input$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"], {
                                    type: "text",
                    ...
                    formData.data.courses.map((course, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                course.branches.map((branch, bIndex)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$input$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"], {
                                                ...
                                                value: branch.bName,
                                                onChange: (e)=>handleChange(e, "bName", "courses", index, bIndex)
                                            }, void 0, false, {
                                                fileName: "[project]/app/admin-dashboard/page.jsx",
                                                lineNumber: 480,
                                                columnNumber: 19
                                            ...
                                            branch.cutOffs.map((cutoff, cIndex)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "mt-2",
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$input$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"], {
                                                            type: "text",
                                                            ...
                                                            value: cutoff.name,
                                                            onChange: (e)=>handleChange(e, "name", "courses", index, bIndex, cIndex)
                                                        }, void 0, false, {
                                                            fileName: "[project]/app/admin-dashboard/page.jsx",
                                                            lineNumber: 497,
                                                            columnNumber: 23
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$input$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"], {
                                                            type: "file",
                                                            accept: "image/*",
                                                            onChange: (e)=>handleCutoffImageUpload(e, index, bIndex, cIndex),
                                                            className: "mt-2"
                                                        }, void 0, false, {
                                                            fileName: "[project]/app/admin-dashboard/page.jsx",
                                                            lineNumber: 512,
...
_s(CreateCollegeForm, "D7BFfG/ut66v5aH8XIJdjI5G17g=");
_c = CreateCollegeForm;
var _c;
__turbopack_context__.k.register(_c, "CreateCollegeForm");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_21ee67e5._.js.map