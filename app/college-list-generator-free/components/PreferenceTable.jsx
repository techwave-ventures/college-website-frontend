    ...
    <div className="rounded-md border overflow-hidden"> {/* Container for rounded corners */}
      <Table className="min-w-full bg-white">
        <TableCaption className="mt-4 mb-2 text-sm text-gray-600">
            Get Your personalized college preference list Now
        </TableCaption>
        <TableHeader className="bg-gray-100">
          <TableRow>
            ...
            {/* <TableHead className="px-3 py-2 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">Cutoff [General]</TableHead> */}
          </TableRow>
        </TableHeader>
